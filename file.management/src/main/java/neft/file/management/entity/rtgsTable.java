...
@Entity
@Table(name="nris_rtgs")
public class rtgsTable {
	@Id
	@Column (name = "UTR_NO")
	...
	public rtgsTable(String uTR_NO, String iNIT_DATE, String aMOUNT, String sTATUS, String fLOW, String pREV_STATUSES,
	...
	public String toString() {
		return "rtgsTable [UTR_NO=" + UTR_NO + ", INIT_DATE=" + INIT_DATE + ", AMOUNT=" + AMOUNT + ", STATUS=" + STATUS
